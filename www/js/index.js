...
var app = {
  ...
  push.on('notification', function(data) {
    ...
    document.getElementById('info').innerHTML = 'notification event received';
  ...
  push.finish(function() {
    ...
    document.getElementById('info').innerHTML = "Push success";
    }, function() {
    console.log('Push Setup Error');
    document.getElementById('info').innerHTML = "Push Failed";
  });
